...
from terrainbento import BasicHy, BasicHySt, NotCoreNodeBaselevelHandler

@pytest.mark.parametrize("Model,param_name", [(BasicHy, "water_erodability"), (BasicHySt, "water_erodability_stochastic")])
